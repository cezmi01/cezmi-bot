...
def load_config(path: str) -> AppConfig:
    ...
    paribu = ParibuConfig(
        ...
        auth_type=paribu_raw.get("auth_type", "hmac_sha256"),
        key_header=paribu_raw.get("key_header", "X-API-KEY"),
        sign_header=paribu_raw.get("sign_header", "X-API-SIGN"),
        signature_param=paribu_raw.get("signature_param"),
        timestamp_param=paribu_raw.get("timestamp_param", "timestamp"),
        recv_window_ms=int(paribu_raw.get("recv_window_ms", 5000)),
        client_order_id_prefix=paribu_raw.get("client_order_id_prefix", "CBOT"),
        post_style=paribu_raw.get("post_style", "params"),
