# main_controller.py
# Python 3.10+
"""Arbitraj ana döngüsü (v1.1)
--------------------------------
Binance ⇄ BTCTurk fiyat farkını izler
• Fark ≥ %THRESHOLD → Binance spot alım + hedge + transfer
• Coin BTCTurk cüzdana düştüğünde satış + short‑kapatma

Fiyat verileri **ticker_karsilastir.py** üzerinden gelir;
main_controller artık kendi REST çağrılarını yapmaz.
"""
