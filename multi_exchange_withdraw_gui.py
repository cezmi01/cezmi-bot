...
class OKXAdapter(BaseExchange):
    ...
    async def withdraw(self, session, symbol, network, address, memo, amount: Decimal):
        ...
        OKX_CHAIN_ALIASES = {
            ...
            "BEP20": ["BEP20", "BSC"],
            "TRC20": ["TRC20", "TRX", "TRON"],
            "ARBITRUM": ["ARBITRUM ONE", "ARBITRUM", "ARBONE"],
            "ARB": ["ARBITRUM ONE", "ARBITRUM", "ARBONE"],
            ...
            "FIL": ["FIL", "FILECOIN"],
            "HBAR": ["HBAR", "HEDERA"],
            "NEO": ["NEO", "N3", "NEO3", "NEO N3", "NEON3"],
            "NEO3": ["NEO", "N3", "NEO3", "NEO N3", "NEON3"],
            "VET": ["VET", "VECHAIN"],
            "THETA": ["THETA"],
            "ZIL": ["ZIL", "ZILLIQA"],
            "ALGO": ["ALGO", "ALGORAND"],
            "ICP": ["ICP", "INTERNET COMPUTER", "IC", "DFINITY"],
            "DYDX": ["DYDX"],
            "SEI": ["SEI"],
            "TIA": ["TIA", "CELESTIA"],
            "INJ": ["INJ", "INJECTIVE"],
