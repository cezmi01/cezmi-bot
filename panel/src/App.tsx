...
export default function App() {
  ...
  const exchanges: Exchange[] = useMemo(
    () => [
      ...
      { id: 'bitexen', name: 'Bitexen', count: 5 },
      { id: 'icrypex', name: 'İcrypex', count: 2 },
      { id: 'bitci', name: 'Bitci', count: 2 },
      { id: 'bithero', name: 'BitHero', count: 3 },
    ...
    () => [
      {
        ...
        cells: {
          ...
          bitexen: [{ kind: 'hot', label: 'HOT' }, { kind: 'cold', label: 'COLD' }],
          icrypex: [{ kind: 'info', label: 'CC1' }],
          bitci: null,
          bithero: [{ kind: 'hot', label: 'HOT' }],
          kucoin: null,
          coinbase: null,
        },
      },
      {
        ...
        cells: {
          ...
          bitget: [{ kind: 'hot', label: 'HOT' }],
          bitexen: [{ kind: 'hot', label: 'HOT' }, { kind: 'cold', label: 'COLD' }],
          icrypex: [{ kind: 'hot', label: 'HOT' }],
          bitci: [{ kind: 'hot', label: 'HOT' }],
          bithero: [{ kind: 'hot', label: 'HOT' }],
